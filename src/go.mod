...
require (
	...
	github.com/golangci/golangci-lint v1.19.0 // indirect
	...
	github.com/honeycombio/opentelemetry-exporter-go v0.0.0-20190924061341-0740775b1a03 // indirect
	...
	go.opentelemetry.io v0.0.0-20190923213910-a3ae50d8bce0
